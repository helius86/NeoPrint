...
class TestWindow(QWidget):
    ...
    def init_ui(self):
        ...
        # Create send layout
        # Create the microcontroller debug monitor
        ...
        receive_layout.addWidget(self.microcontroller_debug_monitor)
    ...
    def connect_microcontroller(self):
        ...
        try:
            ...
            self.debug_monitor.append('Failed to connect to microcontroller')
        ...
        while self.microcontroller_reader_running:
            if self.microcontroller_serial is not None:
                ...
                while self.microcontroller_serial.inWaiting() > 0:
                    response += self.microcontroller_serial.read(self.microcontroller_serial.inWaiting()).decode()
                if response:
